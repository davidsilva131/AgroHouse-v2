    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='bg-white rounded-md shadow-lg fixed top-[50%] left-[50%] -translate-x-2/4 w-full max-w-md max-h-[85vh] p-6 focus:outline-none'>
          <Dialog.Title className='mb-4 font-normal text-green-400 text-base'>Registrate</Dialog.Title>
          ...
          <div className='flex flex-col justify-center mt-25 gap-4'>
            <Dialog.Close asChild>
              <button className='flex justify-center items-center rounded bg-green-400 text-white p-2 hover:shadow-lg hover:opacity-90'>Registrarse</button>
            </Dialog.Close>
            <Dialog.Close asChild>
